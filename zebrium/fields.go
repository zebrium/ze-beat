...
func init() {
	if err := asset.SetFields("metricbeat", "zebrium", asset.ModuleFieldsPri, AssetZebrium); err != nil {
		panic(err)
	}
}

// AssetZebrium returns asset data.
// This is the base64 encoded zlib format compressed contents of module/zebrium.
func AssetZebrium() string {
